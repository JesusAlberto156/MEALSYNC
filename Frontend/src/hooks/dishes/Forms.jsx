...
// Hook para realizar los filtrados de datos ✔️
        ...
        if(currentNView === 'Platillos' && currentSView === 'Menus' && currentMView === 'Platillo-Agregar'){
            const promise = new Promise((resolve,reject) => {
                try{
                    ...
                    setTimeout(() => {
                        if(isTextFieldsDish.nombre === '' || isTextFieldsDish.idmenu === 0 || isTextFieldsDish.descripcion === '' || isTextFieldsDish.precio === '' || isTextFieldsDish.preparacion === ''){
