...
export default function Table_Inventory(){
    ...
    return(
        <>
            <Table id="Table-Status">
                <thead>
                    <Tr>
                        <Th ThemeMode={themeMode}>Tipo de insumo</Th>
                        <Th ThemeMode={themeMode}>Cantidad</Th>
                        <Th ThemeMode={themeMode}>Observaciones</Th>
                    </Tr>
                </thead>
                <tbody>
