                ...
                {isModal && isSelectedRow ? (
                    <Background_Modal>
                        <Background_Modal_Componets>
                            ...
                            {isSelectedRow.habilitado ? <Text_Modal>Se deshabilitará a {user}<br/>¡Cerrará su sesión de forma forzada!...</Text_Modal> : <Text_Modal>Se habilitará a {user}...</Text_Modal>}
