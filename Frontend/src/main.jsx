...
// Rutas
import { PrivateRouteServer } from './routers/Server';
...
import Disconect from './pages/general/Disconect';
import Loading from './pages/general/Loading';
import Login from './pages/general/Login';
import Out_Login from './components/modals/general/OutLogin';
import Authorization_Key from './components/modals/general/AuthorizationKey';
...
import App from './formats/TicketsCocina';
//____________IMPORT/EXPORT____________
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                path: 'Administration/Index/Warehouse/Purchases/Supplies/Add',
                element: <Warehouse_Supply_Add/>,
              },
              {
                path: 'Administration/Index/Warehouse/Purchases/Cleaning/Supplies/Add',
              ...
              {
                path: 'Administration/Authorization_Key',
                element: <Authorization_Key/>,
              }
            ]
          },
          {
