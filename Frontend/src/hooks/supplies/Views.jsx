...
export const HandleModalViewSupplies = () => {
    ...
    const handleModalViewSupplies = (View) => {
        ...
        if(currentMView === 'Insumo-Detalles' && View === ''){
            setIsActionBlock(true);
            setTimeout(() => {
                if(sidebar === 'true'){
                    setIsSidebar(true);
    ...
    return handleModalViewSupplies;
}