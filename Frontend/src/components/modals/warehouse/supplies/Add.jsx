...
export default function Warehouse_Supply_Add(){
    ...
    useEffect(() => {
        if(isTextFieldsWarehouseSupply.idtipo !== 0){
            ...
            const precio = (isTextFieldsWarehouseSupply.cantidadreal * preciounitario).toFixed(4);
    ...
    useEffect(() => {
        if(isWarehouseSupplyAdd){
            const promise = new Promise((resolve,reject) => {
                try{
                    setTimeout(() => {
                        socket.emit('Insert-Warehouse-Supply-Type',isLoggedUser.idusuario,isTextFieldsWarehouseSupply.cantidadreal,isTextFieldsWarehouseSupply.precio,isTextFieldsWarehouseSupply.idtipo,isTextFieldsWarehouseSupply.idcategoria,'Venta-Rapida');
            ...
            Alert_Sonner_Promise(promise,'¡Agregando una venta rapida de insumo!','2');
        }
        ...
        <>
            {isModal ? (
                <Container_Modal_Background_Black>
                    <Image_Modal/>
                    <Container_Modal_Form_White_600 className={currentMView === 'Almacen-Venta-Insumo-Agregar' ? 'slide-in-container-top' : 'slide-out-container-top'}>
                        <Container_Modal_Form_White>
                            <Container_Modal_Form>
                                ...
                                <Modal_Form_Button_Add
                                    ...
                                    onAction={() => handleWarehouseSupplyAdd()}
                                />
                            </Container_Modal_Form>
                        </Container_Modal_Form_White>
