                    ...
                    <Container_Modal ref={Modal_Supply_Types}>
                        <Container_Form_500 ref={Form_Supply_Types} ThemeMode={themeMode} className={currentMView === 'Tipo-Insumo-Eliminar' ? 'slide-in-container-top' : 'slide-out-container-top'}>
                            <Container_Row_100_Center>
                                <Text_Title_30_Center ThemeMode={themeMode}>ELIMINAR TIPO DE ISNUMO</Text_Title_30_Center>
                            </Container_Row_100_Center>
                            <Form_Verification/>
                            <Container_Row_NG_95_Center>
                                <Text_Blue_16_Left ThemeMode={themeMode}>Tipo de isnumo:</Text_Blue_16_Left>
                                <Text_A_16_Left ThemeMode={themeMode}> {isTextFieldsSupplyType.tipo || 'Desconocida'}...</Text_A_16_Left>
                            </Container_Row_NG_95_Center>
                            <Container_Row_95_Center>
                                <Text_A_12_Justify ThemeMode={themeMode}>La eliminación de este tipo de insumo impedirá agregarle nuevos insumos o reasignar sus insumos a un tipo de insumo distinto.</Text_A_12_Justify>
                            </Container_Row_95_Center>
                            <Container_Row_95_Center>
