...
export const HandleModalViewMenuTypes = () => {
    ...
    // Función del hook
    const handleModalViewMenuTypes = (View) => {
        setIsModal(true);
        sessionStorage.setItem('Estado del Modal',true);
        const route = sessionStorage.getItem('Ruta');
        const sidebar = sessionStorage.getItem('Estado del Sidebar');
        // TIPOS DE MENÚ ✔️
        if(currentMView === 'Tipo-Menu-Agregar' && View === ''){
        ...
        if(currentMView === 'Tipo-Menu-Editar' && View === ''){
            setIsActionBlock(true);
            setTimeout(() => {
                if(sidebar === 'true'){
                    setIsSidebar(true);
        ...
        if(currentMView === 'Tipo-Menu-Eliminar' && View === ''){
            setIsActionBlock(true);
            setTimeout(() => {
                if(sidebar === 'true'){
                    setIsSidebar(true);
    ...
    return handleModalViewMenuTypes;
}