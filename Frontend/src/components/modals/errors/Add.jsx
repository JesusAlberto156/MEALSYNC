...
// Modal para el error de agregar de los modales
export default function Error_Add(){
        ...
        <>
            <Container_Modal>
                <Container_Column_90_Center>
                    <Text_White_40_Center>¡Ha perdido los datos para agregar!</Text_White_40_Center>
