...
export default function Supply_Delete(){
    ...
    useEffect(() => {
        if(isSupplyDelete){
            ...
            Alert_Verification(promise,'Eliminando un insumo!...');
        }
    },[isSupplyDelete]);
                    ...
                    <Container_Modal ref={Modal_Supplies}>
                        <Container_Form_500 ref={Form_Supplies} ThemeMode={themeMode} className={currentMView === 'Insumo-Eliminar' ? 'slide-in-container-top' : 'slide-out-container-top'}>
                            <Container_Row_100_Center>
                                <Text_Title_30_Center ThemeMode={themeMode}>ELIMINAR INSUMO</Text_Title_30_Center>
                            </Container_Row_100_Center>
                            <Form_Verification/>
                            <Container_Row_NG_95_Center>
                                <Text_Blue_16_Left ThemeMode={themeMode}>Insumo:</Text_Blue_16_Left>
