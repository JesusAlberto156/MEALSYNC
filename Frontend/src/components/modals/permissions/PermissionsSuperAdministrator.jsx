                ...
                {isModal && isSelectedRow ? (
                    <Background_Modal>
                        <Background_Modal_Componets>
                            ...
                            {isSelectedRow.superAdmon ? <Text_Modal>{user} pierde el permiso <Icon_Warning_Modal><FaExclamationCircle /><Icon_Tooltip_Modal>¡Cerrará su sesión de forma forzada!...</Icon_Tooltip_Modal></Icon_Warning_Modal></Text_Modal> : <Text_Modal>{user} gana el permiso...</Text_Modal>}
